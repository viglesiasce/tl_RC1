...
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'testcases/tcView.tpl', 18, false),array('function', 'lang_get', 'testcases/tcView.tpl', 19, false),array('modifier', 'escape', 'testcases/tcView.tpl', 136, false),)), $this); ?>
...
" target="_blank"><?php echo $this->_tpl_vars['gui']->direct_link; ?>
		...
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "testcases/tcView_viewer.tpl", 'smarty_include_vars' => array('args_testcase' => $this->_tpl_vars['gui']->tc_current_version[$this->_sections['idx']['index']][0],'args_keywords_map' => $this->_tpl_vars['gui']->keywords_map[$this->_sections['idx']['index']],'args_reqs' => $this->_tpl_vars['gui']->arrReqs[$this->_sections['idx']['index']],'args_status_quo' => $this->_tpl_vars['gui']->status_quo[$this->_sections['idx']['index']],'args_can_do' => $this->_tpl_vars['gui']->can_do,'args_can_move_copy' => 'yes','args_can_delete_testcase' => 'yes','args_can_delete_version' => $this->_tpl_vars['my_delete_version'],'args_show_version' => 'yes','args_show_title' => $this->_tpl_vars['gui']->show_title,'args_activate_deactivate_name' => 'activate','args_activate_deactivate' => 'bnt_activate','args_cf' => $this->_tpl_vars['gui']->cf_current_version[$this->_sections['idx']['index']],'args_tcase_cfg' => $this->_tpl_vars['gui']->tcase_cfg,'args_users' => $this->_tpl_vars['gui']->users,'args_tproject_name' => $this->_tpl_vars['gui']->tprojectName,'args_tsuite_name' => $this->_tpl_vars['gui']->parentTestSuiteName,'args_linked_versions' => $this->_tpl_vars['gui']->linked_versions[$this->_sections['idx']['index']],'args_has_testplans' => $this->_tpl_vars['gui']->has_testplans)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
" class="workBack">
    ...
    foreach ($_from as $this->_tpl_vars['tdx'] => $this->_tpl_vars['my_testcase']):
?>
