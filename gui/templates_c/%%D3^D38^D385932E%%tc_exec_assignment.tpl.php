<?php /* Smarty version 2.6.26, created on 2010-10-18 12:33:42
...
' />
 ...
 />
  ...
  <?php if ($this->_tpl_vars['gui']->has_tc): ?>
   <div class="workBack">
	  <?php $this->assign('table_counter', 0); ?>
...
"  value="0" />
          ...
          <?php if ($this->_tpl_vars['ts']['testcase_qty'] > 0): ?>
	          <?php $this->assign('table_counter', $this->_tpl_vars['table_counter']+1); ?>
            <table cellspacing="0" style="font-size:small;" width="100%" id="the-table-<?php echo $this->_tpl_vars['table_counter']; ?>
">
            			      			      <thead>
...
<?php echo $this->_tpl_vars['gsmarty_gui']->role_separator_close; ?>
              ...
              <?php endif; ?>	
			      	<?php if ($this->_tpl_vars['session'] ['testprojectOptions']->testPriorityEnabled): ?>
			      	  <th align="center"><?php echo $this->_tpl_vars['labels']['priority']; ?>
</th>
			      	<?php endif; ?>
              <th align="center">&nbsp;&nbsp;<?php echo $this->_tpl_vars['labels']['assigned_to']; ?>
</th>
              <th align="center">&nbsp;&nbsp;<?php echo $this->_tpl_vars['labels']['assign_to']; ?>
</th>
            </tr>
			      </thead>
                        <tbody>  
...
?> </div> <?php endfor; endif; ?>
  ...
  loop2do=<?php echo $this->_tpl_vars['table_counter']; ?>
;
  </script>
