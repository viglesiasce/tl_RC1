...
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/tcView_viewer.tpl', 35, false),array('modifier', 'escape', 'testcases/tcView_viewer.tpl', 76, false),)), $this); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "testcases/inc_tcbody.tpl", 'smarty_include_vars' => array('inc_tcbody_close_table' => false,'inc_tcbody_testcase' => $this->_tpl_vars['args_testcase'],'inc_tcbody_show_title' => $this->_tpl_vars['args_show_title'],'inc_tcbody_tableColspan' => $this->_tpl_vars['tableColspan'],'inc_tcbody_labels' => $this->_tpl_vars['tcView_viewer_labels'],'inc_tcbody_author_userinfo' => $this->_tpl_vars['author_userinfo'],'inc_tcbody_updater_userinfo' => $this->_tpl_vars['updater_userinfo'],'inc_tcbody_cf' => $this->_tpl_vars['args_cf'])));
...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "testcases/inc_steps.tpl", 'smarty_include_vars' => array('layout' => $this->_tpl_vars['gui']->steps_results_layout,'edit_enabled' => $this->_tpl_vars['edit_enabled'],'steps' => $this->_tpl_vars['args_testcase']['steps'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
